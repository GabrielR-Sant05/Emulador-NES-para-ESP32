...
def add_nes_header(bin_file, nes_file):
    # Cabeçalho NES padrão para o formato iNES
    nes_header = bytearray([
        0x4E, 0x45, 0x53, 0x1A, # Identificador "NES" e EOF marker
        0x01,                   # Número de bancos PRG-ROM (16 KB cada)
        0x01,                   # Número de bancos CHR-ROM (8 KB cada)
        0x00,                   # Flags 6
        0x00,                   # Flags 7
        0x00, 0x00, 0x00, 0x00, # Flags 8-11 (unused)
        0x00, 0x00, 0x00, 0x00  # Flags 12-15 (unused)
    ])
...
# Uso
add_nes_header('mario.bin', 'mario.nes')
